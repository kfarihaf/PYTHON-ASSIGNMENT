...
print(f"Welcome{name},lets check your avaailability")
place=input("where are you from?:(india/others)")
place=place.lower()
if (place!="india"):
  print("only indians are allowed to vote")
else:
  exp=input("Have you experienced voting before:(YES/NO)")
  exp=exp.lower()
  if(exp=="yes"):
    print("great going,keep up for voting in the future")
  else:
    print("voting is a fundemental right and you can make use of it ,letss check your eligibility")
  interest=input("would you like to vote:(YES/NO)")
  interest=interest.lower()
  if(interest!="yes"):
    print("thank you, you may give the vote next time")
  else:
     print("great,you may proceed")
     byear=(input('Which year were you born:(DD/MM/YYYY)'))
     byear=byear.split('/')
     byear=int(byear[2])
     ...
     proj=input("Did you like our project:(YES/NO)")
     proj=proj.lower()
     if(proj=="yes"):
       print("great to know")
     else:
      print("do let us know how we can improve")
      rate=int(input("Please give us rating out of 5?"))
      if(rate<5):
...
# vi) b,c are greater
# vii) all are equal
a=int(input("the first input number is:"))
b=int(input("the second input number is:"))
c=int(input("the third input number is:"))
if(a>b)and(a>c):
  print('a is greater')
elif(b>a)and(b>c):
  print('b is greater')
...
operation=input("enter the operation you need to apply:\n 1)Multiplication,2)Division,3)Addition,4)Subtraction,5)Percentage,6)squareroot,7)exponentiation,8)floor,9)ceil:")
if(operation=="1"):
  ...
  print(f"squareroot is:{n**(1/2)}")
elif(operation=="7"):
  a=float(input("enter the Number:"))
  b=float(input("enter exponent value:"))
  ...
  import math
  ceil = math.ceil(a)
  print(f"ceil value is :{ceil}")
else:
  print("enter the number assigned from the given list of operations")